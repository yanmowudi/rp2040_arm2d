...
/* ARM::Acceleration:Arm-2D Extras:Controls:1.4.4 */
#define RTE_Acceleration_Arm_2D_Extra_Controls
/* ARM::Acceleration:Arm-2D Extras:LCD ASCII Printf:2.0.0 */
#define RTE_Acceleration_Arm_2D_Extra_LCD_printf__
/* ARM::Acceleration:Arm-2D Helper:Display Adapter:1.6.3 */
